...
Here's the thing that nobody talks about: analysts don't complain because they assume the workflow is intentional. They think the clicks are just how the tool works, so they absorb the friction as normal. Managers don't measure it because the analyst appears productive. And vendors don't fix it because nobody files the ticket.
